...
if (currentSeason === "Spring" || currentSeason === "Reunification Day") {
    ...
    document.getElementById("credit").innerText = "[Credit for the background] Original: Guido Gerding / Wikimedia Commons / &laquo;XN Fruehjahrswiese 00&raquo; / CC BY-SA 3.0";
    }
    ...
    document.getElementById("credit").innerText = "[Credit for the background] Original: Luc Viatour | https://Lucnix.be / Wikimedia Commons / &laquo;Field Hamois Belgium Luc Viatour&raquo; / CC BY-SA 3.0";
    }
    ...
    document.getElementById("credit").innerText = "[Credit for the background] Original: Dietmar Rabich (Derivative work: Sting) / Wikimedia Commons / &laquo;Dülmen, Wildpark -- 2014 -- 3808 color balanced&raquo; / CC BY-SA 4.0;"
    }
else {
    ...
    document.getElementById("credit").innerText = "[Credit for the background] Original: Ernst Vikne / Wikipedia Commons / &laquo;Winter forest silver&raquo; / CC BY-SA 2.0";
    }