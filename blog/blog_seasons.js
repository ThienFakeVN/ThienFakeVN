...
if (currentSeason === "Spring" || currentSeason === "Reunification Day") {
    ...
    document.getElementById("season").innerText = "Credit to the background: Original: Dietmar Rabich (Derivative work: Sting) / Wikimedia Commons / “Dülmen, Wildpark -- 2014 -- 3808 color balanced” / CC BY-SA 4.0;"
    ...
    document.getElementById("season").innerText = "Credit to the background: Original: Ernst Vikne / Wikipedia Commons / “Winter forest silver” / CC BY-SA 2.0";
