...
if (currentSeason === "Spring" || currentSeason === "Reunification Day") {
    ...
    document.getElementById("credit").innerText = "Credit to the background: Original: Guido Gerding / Wikimedia Commons / “XN Fruehjahrswiese 00” / CC BY-SA 3.0";
    ...
    document.getElementById("credit").innerText = "Credit to the background: Original: Luc Viatour | https://Lucnix.be / Wikimedia Commons / “Field Hamois Belgium Luc Viatour” / CC BY-SA 3.0";
    ...
    document.getElementById("season").innerText = "body {background-image: url('https://upload.wikimedia.org/wikipedia/commons/d/d0/D%C3%BClmen%2C_Wildpark_--_2014_--_3808_color_balanced.jpg');}";
    document.getElementById("credit").innerText = "Credit to the background: Original: Dietmar Rabich (Derivative work: Sting) / Wikimedia Commons / “Dülmen, Wildpark -- 2014 -- 3808 color balanced” / CC BY-SA 4.0;"
    } // Original: Dietmar Rabich (Derivative work: Sting) / Wikimedia Commons / “Dülmen, Wildpark -- 2014 -- 3808 color balanced” / CC BY-SA 4.0
else {
    document.getElementById("season").innerText = "body {background-image: url('https://upload.wikimedia.org/wikipedia/commons/b/b0/Winter_forest_silver.jpg');}";
    document.getElementById("credit").innerText = "Credit to the background: Original: Ernst Vikne / Wikipedia Commons / “Winter forest silver” / CC BY-SA 2.0";
